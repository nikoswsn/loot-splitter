...
function calculateLoot() {
    ...
    const rsPp = document.getElementById('rs-pp').innerHTML = platinumPerMember
    const rsGp = document.getElementById('rs-gp').innerHTML = goldPerMember
    const rsEp = document.getElementById('rs-ep').innerHTML = electrumPerMember
    const rsSp = document.getElementById('rs-sp').innerHTML = silverPerMember
    const rsCp = document.getElementById('rs-cp').innerHTML = copperPerMember
    const remainingEl = document.getElementById('remaining').innerHTML = remainingCopper
...
function copyText() {
    ...
    const textToCopy =`Each member gets: ${platinumPerMember}PP, ${goldPerMember}GP, ${electrumPerMember}EP, ${silverPerMember}SP, ${copperPerMember}CP
